package com.jing21.simpleswagger2;
...
public class Swagger2AutoConfiguration implements BeanFactoryAware {
    ...
    @Bean
    public List<Docket> apis(SwaggerProperties swaggerProperties) {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "swagger.oAuth2", value = "enable", havingValue = "true")
